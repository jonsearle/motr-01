...
function TrashIcon() {
  return (
    <svg width="22" height="24" viewBox="0 0 40 43" fill="none" aria-hidden>
      <path
        d="M6.1665 12.5417H34.8332M16.9165 19.7083V30.4583M24.0832 19.7083V30.4583M7.95817 12.5417L9.74984 34.0417C9.74984 34.992 10.1274 35.9035 10.7994 36.5755C11.4714 37.2475 12.3828 37.625 13.3332 37.625H27.6665C28.6169 37.625 29.5283 37.2475 30.2003 36.5755C30.8723 35.9035 31.2498 34.992 31.2498 34.0417L33.0415 12.5417M15.1248 12.5417V7.16667C15.1248 6.69149 15.3136 6.23577 15.6496 5.89977C15.9856 5.56376 16.4413 5.375 16.9165 5.375H24.0832C24.5583 5.375 25.0141 5.56376 25.3501 5.89977C25.6861 6.23577 25.8748 6.69149 25.8748 7.16667V12.5417"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
